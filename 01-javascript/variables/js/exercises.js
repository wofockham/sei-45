...
const ageMessage = `The are either ${ ageBeforeBirthday } or ${ ageAfterBirthday }`;
...
console.log(`You will need ${ amountRequired } to last until the ripe old age of ${ deathAge }`);
