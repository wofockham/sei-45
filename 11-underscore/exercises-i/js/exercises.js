...
const sum = _(numbers).reduce(add); // .inject &:+ // symbol to proc
console.log(sum);
...
const user3 = _(people).findWhere({id: 3}); // a single object
console.log(user3);
...
const youngster = _(people).find(youngPerson); // a single object
